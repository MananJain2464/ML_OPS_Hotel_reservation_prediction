...
class ModelTraining: 
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.info(f'Model evaluation results: accuracy={accuracy}, precision={precision}, recall={recall}, f1={f1}')
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info(f'Running our MLFLOW experimentation')
            ...
            raise CustomException('Failed to pipeline the model training', e)
